...
let showCrown = localStorage.getItem('showCrown') !== 'false'; // по умолчанию true
...
function updateCrownVisibility() {
    // Перерисовываем диалоги и заголовок чата, если нужно
    renderDialogs();
    if (currentChatUser) {
...
def admin_messages(user):
    # Возвращаем сообщения без ботов test1 и test2
